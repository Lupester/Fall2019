...
#              When the program starts, load each "row" of data1
#              in "ToDoToDoList.txt" into a python Dictionary.
#              Add the each dictionary "row" to a python list "table"
# ChangeLog (Who,When,What):
# RRoot,1.1.2030,Created started script
# GFlores,11.5.2019,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
# -- Data -- #
...
while True:
    ...
    print()
# Step 3 - Shows the current items in the table
    if strChoice.strip() == '1':
        for row in lstTable:
             print(row['task'] + ',' + row['priority'])
        continue
# Step 4 - Adds a new item to the list/Table
        ...
        lstTable.append(dicRow)
        continue
# Step 5 - Removes a new item to the list/Table
        ...
        continue
# Step 6 - Save the items to the ToDoList.txt file
